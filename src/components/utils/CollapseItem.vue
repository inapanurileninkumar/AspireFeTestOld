<template>
  <div>
    <div
      :class="[headerClass, (expanded?'':'')]"
      class="flex-box align-center justify-content-sb pointer-cursor"
      @click="toggleCollapse"
    >
      <div
        :class="showIcon?'col-xl-11 col-lg-11 col-md-11 col-sm-11 col-xs-11':'col-12'"
      >
        <slot name="header"/>
      </div>
      <div
        v-if="showIcon"
        class="col-xl-1 col-lg-1 col-md-1 col-sm-1 col-xs-1 flex-box justify-center"
      >
        <i
          :class="expanded?expandIcon:collapseIcon"
        />
      </div>
    </div>
    <div
